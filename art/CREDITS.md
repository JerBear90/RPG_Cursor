...
| Role | File |
|------|------|
| Player 1 (Matt) | `art/characters/player1/exiled_survivor_matt.gltf` |
| Player 2 (Sam) | `Characters_Sam_SingleWeapon.gltf` |
| Forest Bandit | `Characters_Shaun_SingleWeapon.gltf` |
| Shield Bandit | `Characters_Sam_SingleWeapon.gltf` |
| Bandit Archer | `Characters_Lis_SingleWeapon.gltf` |
| Bandit Captain | `Characters_Shaun.gltf` |
| Hollow Grove Warden | `Zombie_Chubby.gltf` |
