extends Node
## Persists Blackvein Foundry dungeon state.
...
func deserialize(data: Dictionary) -> void:
	...
	vent_active = bool(data.get("vent_active", false))
	rail_active = bool(data.get("rail_active", false))
	furnace_active = bool(data.get("furnace_active", false))
